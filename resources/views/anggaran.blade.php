...
@section('css')
    ...
    <style>
        ...
        .page-hero-overlay::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(105deg, transparent 45%, rgba(201, 168, 76, .06) 55%, transparent 65%);
        }
...
@section('content')
    <section class="page-hero">
        <img class="hero-bg" src="{{ asset('assets/local/anggaran.png') }}" alt="Bidang Anggaran">
        <div class="page-hero-overlay"></div>
        <div class="page-hero-content">
            <div class="page-hero-badge">Bidang Anggaran</div>
            <h1 class="page-hero-title">Anggaran Badan Pengelolaan<br><span>Keuangan dan Aset Daerah</span></h1>
            <p class="page-hero-desc">
                Dipimpin oleh seorang Kepala Bidang yang berkedudukan di bawah dan bertanggung jawab kepada Kepala Badan
                melalui sekretaris.
            </p>
                ...
                <div class="panel-inner">
                    <div class="panel-header">
                        ...
                        <div><span class="panel-eyebrow">Uraian</span>
                            <h2 class="panel-title">Tugas Anggaran</h2>
                        </div>
                    </div>
