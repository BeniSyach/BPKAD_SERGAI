{{-- resources/views/produk-hukum-perwali.blade.php --}}
@extends('base')

@section('css')
    {{-- Salin semua CSS dari produk-hukum-perda.blade.php --}}
    <link
...
@section('content')
    ...
    {{-- ── HERO ──────────────────────────────────────────── --}}
    <section class="hero">
        <img class="hero__bg" src="{{ asset('assets/local/produkhukum.png') }}" alt="Produk Hukum Perwali">
        <div class="hero__overlay"></div>
        <div class="hero__corner"></div>
        <div class="hero__content">
            <div class="hero__eyebrow">PPID &mdash; BPKAD &mdash; Kab. Serdang Bedagai</div>
            <h1 class="hero__title">Produk Hukum <em>Perwali</em></h1>
            <p class="hero__desc">
                Peraturan Wali BPKAD Kabupaten Serdang Bedagai yang berlaku
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__inner">
            ...
            <span class="sep">›</span>
            <span class="active">Perwali</span>
        </div>
    </div>
    ...
    <div class="page-outer">
        ...
        <div class="toolbar">
            <div class="search-wrap">
                ...
                <input type="text" class="search-input" id="perwali-search" placeholder="Cari nama Perwali..."
                    autocomplete="off">
            </div>
            <div class="count-badge">
                <span class="dot"></span>
                <span id="count-label">{{ count($mayors ?? []) }} Perwali</span>
            </div>
        </div>
        ...
        <div class="main-card">
            ...
            <div class="main-card__header">
                ...
                <div>
                    ...
                    <h2 class="main-card__title">Produk Hukum Perwali</h2>
                </div>
            </div>

            {{-- List --}}
            <ul class="perda-list" id="perwali-list">
                @forelse ($mayors ?? [] as $mayor)
                    <li class="perda-item" data-name="{{ strtolower($mayor->name) }}"
                        ...
                        <span class="perda-name">{{ $mayor->name }}</span>

                        @if ($mayor->link)
                            @if ($mayor->type == 1)
                                <a class="perda-link perda-link--url" href="{{ $mayor->link }}" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                        <path
                            ...
                            @else
                                <a class="perda-link perda-link--file" href="{{ $mayor->link }}" target="_blank"
                                    rel="noopener">
                                    <svg viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                ...
                @empty
                    <li>
                        <div class="empty-state">
                            ...
                            <p class="font-medium">Belum ada data Perwali tersedia.</p>
                        </div>
                    </li>
                @endforelse
            </ul>
            ...
            <div id="no-results">
                ...
                Tidak ditemukan Perwali yang sesuai.
            </div>
        </div>
        ...
        <div class="footer-note">
            ...
            <div class="footer-note__text">
                <h3>Tentang Produk Hukum Perwali</h3>
                <p>
                    Peraturan Wali ini diterbitkan oleh BPKAD Kabupaten Serdang Bedagai
...
@section('morejs')
    <script>
        (function() {
            const searchInput = document.getElementById('perwali-search');
            const list = document.getElementById('perwali-list');
            ...
            searchInput.addEventListener('input', function() {
                ...
                countLabel.textContent = `${visible} Perwali${q ? ' ditemukan' : ''}`;
            });
        })();
    </script>
@endsection
