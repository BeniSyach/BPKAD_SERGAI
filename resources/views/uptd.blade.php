...
@section('css')
    ...
    <style>
        ...
        .page-hero-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(160deg, rgba(11, 31, 58, .92) 0%, rgba(18, 48, 92, .78) 60%, rgba(11, 31, 58, .55) 100%);
        }
        ...
        .panel-card:hover {
            box-shadow: 0 1px 2px rgba(0, 0, 0, .04), 0 16px 48px rgba(11, 31, 58, .14);
...
@section('content')
    <section class="page-hero">
        <img class="hero-bg" src="{{ asset('assets/local/uptd.png') }}" alt="UPTD">
        <div class="page-hero-overlay"></div>
        <div class="page-hero-content">
            <div class="page-hero-badge">UPTD</div>
            <h1 class="page-hero-title">Unit Pelaksana Teknis<br><span>Pelayanan Publik</span></h1>
            <p class="page-hero-desc">UPTD hadir sebagai unit pelaksana teknis yang bertugas memberikan pelayanan dan
                pengelolaan sesuai bidangnya, agar pelayanan masyarakat menjadi lebih cepat, mudah, dan tepat sasaran.</p>
        </div>
    </section>
                ...
                <div class="panel-inner">
                    <div class="panel-header">
                        ...
                        <div><span class="panel-eyebrow">Uraian</span>
                            <h2 class="panel-title">Tugas UPTD</h2>
                        </div>
                    </div>
                        ...
                        <div class="gallery-wrap">
                            <div class="slider-for mb-3">
                                @foreach ($data->images as $d)
                                    <div><img src="{{ asset($d->image) }}" onclick="showModal('{{ asset($d->image) }}')"
                                            alt="Gallery image" /></div>
                                @endforeach
                            </div>
                            <div class="slider-nav">
                                @foreach ($data->images as $d)
                                    <div><img src="{{ asset($d->image) }}" alt="Thumbnail" /></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
