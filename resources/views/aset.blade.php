...
@section('content')
    <section class="page-hero">
        <img class="hero-bg" src="{{ asset('assets/local/aset.png') }}" alt="Bidang Aset">
        <div class="page-hero-overlay"></div>
        <div class="page-hero-content">
            <div class="page-hero-badge">Bidang Aset</div>
            <h1 class="page-hero-title">Aset Badan Pengelolaan<br><span>Keuangan dan Aset Daerah</span></h1>
                ...
                <div class="panel-inner">
                    <div class="panel-header">
                        ...
                        <div><span class="panel-eyebrow">Uraian</span>
                            <h2 class="panel-title">Tugas Aset</h2>
                        </div>
                    </div>
