...
@section('content')
    ...
    <div class="breadcrumb">
        <div class="breadcrumb__inner">
            ...
            <a href="#">PPID</a>
            <span class="sep">›</span>
            <span class="active">Informasi Setiap Saat</span>
        </div>
    </div>
    ...
    <div class="page-outer">
            ...
            <div class="table-card__header">
                <div class="table-card__title-wrap">
                    ...
                    <div>
                        ...
                        <h2 class="table-card__title">Informasi Setiap Saat</h2>
                    </div>
                </div>
            ...
            <div class="table-card__body">
                ...
                <div class="doc-legend">
                    ...
                    <div class="doc-legend-item">
                        <a class="doc-link doc-link--url" style="pointer-events:none;">Tautan</a> = Tautan eksternal
                    </div>
                    <div class="doc-legend-item">
                        <a class="doc-link doc-link--file" style="pointer-events:none;">Dokumen</a> = File unduhan
                    </div>
                    <div class="doc-legend-item">
                        <span class="doc-empty"></span> = Belum tersedia
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-note">
            ...
            <div class="footer-note__text">
                <h3>Tentang Informasi Setiap Saat</h3>
                <p>Informasi ini harus selalu tersedia untuk publik sesuai UU No. 14 Tahun 2008.</p>
            </div>
        </div>
    </div>
